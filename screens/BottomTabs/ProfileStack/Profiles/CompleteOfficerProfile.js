...
import { CompleteOfficerProfileHandler } from "../../../../utils/requests";

function CompleteOfficerProfile({ navigation }) {
  ...
  function saveProfileHandler() {
    ...
    CompleteOfficerProfileHandler(formUpload, {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {/* <Text style={[styles.up, { marginTop: 12, marginLeft: 15 }]}>
              Profile Picture.
            </Text> */}
            <ImagePicker
...
export default memo(CompleteOfficerProfile);
